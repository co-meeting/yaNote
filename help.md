...
このヘルプガイドでは、yaNote v1.3 の基本操作や各機能の使い方について、実際の動作に基づいて説明します。
...
yaNote v1.3 は、ユーザーが直感的に情報を整理・編集できるツールとして、以下の操作を実現しています。
...
- **全オブジェクト選択**:  
  - Cmd/Ctrl+A キーの同時押しにより、キャンバス上の全ノードおよび接続線を一括で選択できます.  
  - ただし、ノードのテキスト編集中の場合は、ブラウザの標準全選択動作（テキスト全選択）が実行されます.
...
- **PWA対応**:  
  - yaNote は PWA として動作し、Service Worker により主要リソースがキャッシュされ、オフライン環境でも基本機能が利用可能です.  
  - 新バージョンがリリースされた際は、skipWaiting() や clients.claim() の活用により迅速な更新が実現されます.

本ヘルプガイドは、yaNote v1.3 の基本操作および各機能の使い方について記述しており、実際の動作に基づいた情報を提供します。  
