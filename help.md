...
このヘルプでは、yaNote v1.3.3 の基本操作や各機能の使い方について、実際の動作に基づいて説明します。
...
yaNote v1.3.3 は、ユーザーが直感的に情報を整理・編集できるツールとして、以下の操作を実現しています。
...
本ヘルプは、yaNote v1.3.3 の基本操作および各機能の使い方について記述しており、実際の動作に基づいた情報を提供します。  
