...
このヘルプでは、yaNote v1.3.5.7 の基本操作や各機能の使い方について、実際の動作に基づいて説明します。
...
| Enter                      | ノード編集中            | Enterキーを押す                                                  | ノードの編集を確定し、リンク形式に変換                    |
...
本ヘルプは、yaNote v1.3.5.7 の基本操作および各機能の使い方について記述しており、実際の動作に基づいた情報を提供します。  
