...
このヘルプでは、yaNote v1.4.1 の基本操作や各機能の使い方について、実際の動作に基づいて説明します。
...
| その他ショートカット        | 全体の操作              | Ctrl/Cmd+Enter, e, Shift+Enter, Ctrl/Cmd+Z, Ctrl/Cmd+Y, Delete  | キーボード利用時のみ                                            | ノード生成、編集、Undo／Redo、削除など.  |
...
本ヘルプは、yaNote v1.4.1 の基本操作および各機能の使い方について記述しており、実際の動作に基づいた情報を提供します。  
